    ...
    return (
        <section id='contact' className="mb-32">
            <div id="map" className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3592.1109678572366!2d68.48826187446336!3d25.799912907026876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x394b9586abb445d9%3A0x4061300801f98168!2sUniversity%20of%20Sufism%20and%20Modern%20Sciences!5e0!3m2!1sen!2s!4v1726024962563!5m2!1sen!2s"
                                ...
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-6 grow">
                                            ...
                                            <p className="text-sm text-neutral-500">
                                                Univeristy Area, University of Sufism Bhitshah
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="shrink-0">
                                            <div className="inline-block rounded-md bg-sky-200 p-4 text-primary">
                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" className="w-7 h-7"
                                ...
                                <div className="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                                    <div className="align-start flex">
                                        ...
                                        <div className="ml-6 grow">
                                            ...
                                            <p className="text-neutral-500"> +92 123456789
                                            </p>
                                        </div>
                                    </div>
                                </div>
